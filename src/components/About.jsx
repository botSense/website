...
const About = () => {
  return (
    <div
      name="about"
      className="w-full h-screen flex flex-col sm:justify-center items-center text-center p-10 gap-8 text-gray-300"
    >
      ...
      <p>
        ...
        stakeholders and customers. We’ll achieve this by focusing on the
        intersection of our client’s emerging needs and the acceleration of
